		...
		<div class="twelve wide column">
			<div class="ui center aligned segment">
				<div class="ui compact segment" style="margin: 0 auto;">
					<img src="groups/avatars/<?= $User["id"] ?>" alt="Avatar" id="avatar-img" style="max-width: 400px;">
				</div>
				<form action="/settings/avatar/groups" method="post" enctype="multipart/form-data" class="little top margin">
